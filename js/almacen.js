...
var almacen = {
	...
	mostrarResultadosHistorial: function(tx, res){//primer parametro es transaccion y el segundo es el resultado
		var cantidad = res.rows.length;
		...
		if(cantidad > 0){
			...
			for( var i = 0; i < cantidad; i++){
				//rows son los registros, iten el indice, y al final el nombre de cada campo
